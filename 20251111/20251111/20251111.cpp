// 20251111.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    // TODO: 여기에 코드를 입력합니다.
    HANDLE mux;
    // OS에게 "예에"라는 이름의 Mutex가 존재하는지 확인
    ...
    LoadStringW(hInstance, IDC_MY20251111, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY20251111));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY20251111));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_MY20251111);
...
DWORD WINAPI pig_sem(LPVOID param)
{
    ...
    {
        // Semaphore 대기 API
        WaitForSingleObject(g_sem, INFINITE);       // 무제한 대기
        //////////////////////////////// 임계 영역 시작
        g_x = x;
        MoveToEx(hdc, g_x, 0, NULL);
        LineTo(hdc, g_x, i);
