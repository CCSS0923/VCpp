// 20250930.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY20250930, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY20250930));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY20250930));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_MY20250930);
...
// 생명력을 보관하는 변수
int g_my_life = 5;
// 게임 상태를 확인할 수 있는 변수 : FALSE(게임중), TRUE(게임 종료)
BOOL g_gameover;
// 상대 이동 속도 결정 보관 변수
int g_interval = 1000;
    ...
    case WM_PAINT:
        {
            ...
            wsprintf(bufc, L"Score : %d", g_score);
            TextOut(hdc, 500, 10, bufc, lstrlenW(bufc));
            EndPaint(hWnd, &ps);
        }
        break;
    case WM_DESTROY:
