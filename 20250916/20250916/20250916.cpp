// 20250916.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY20250916, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY20250916));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY20250916));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_MY20250916);
...
// 시작 점의 좌표를 보관할 전역 변수
int g_x, g_y;
// 선택한 그리기 종류를 별도로 보관할 플래그 변수
// 0 - 그리지 않는다, 1 - 선 그리기, 2 - 사각형 그리기, 3 - 타원 그리기, 4 - 자유선 그리기
int g_flag;
